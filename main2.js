...
*/
      ...
      $this.parent().find("span.computing-message").show( 100, function(){
        ...
        //console.log(currentIndividualPeriodicWaves);
...
// Constructor. the value of 'this' will be the new object created.
function Carrier(  ) {
  this.noteOff();
  this.load();
  ...
  processor.onaudioprocess = function(event){
    ...
    for (var channel = 0; channel < outputBuff.numberOfChannels; channel++) {
      ...
      for (var sample = 0; sample < inputBuff.length; sample++) {
        ...
        // manipulate each output sample
        outputData[sample] *=  modulationWave[sample] * 0.7;// add neurons here
      }
    }
...
function playSelectedWaveformsForOneQuarterNoteC3( recordSample ) {
  ...
  if( useEnvelope ) {
    ...
    noteOscillators["carrier"].noteOn(  audioContext.currentTime );
    /*
...
masterGain.connect( audioContext.destination, 0, 0 );
